...
public class ParticleSystemVisibilityScript : MonoBehaviour
{
    public ParticleSystem myParticleSystem; // reference to the render you want toggled based on the position of this transform
    ...
    private void Awake()
    {
        _camera = GameObject.Find("FogOfWarCam").GetComponent<Camera>(); // Unexplored areas cam
    }
    ...
    void LateUpdate()
    {
        ...
        emissionModule.enabled = isVisible;
    }
}